...
<head>
  ...
  <link rel="stylesheet" crossorigin href="<?= base_url('assets/dist') ?>/assets/compiled/css/auth.css">
</head>
<style type="text/css">
    img {
        opacity: 0.8;
...
<div class="row h-100">
    <div class="col-lg-5 col-12">
        <div id="auth-left">
            <div class="auth">
                <h1 class="text-gray-600">Give2Give</h1>
            </div>
            <h1 class="auth-title">Log in.</h1>
            <p class="auth-subtitle mb-4">Silahkan login terlebih dahulu</p>
            <?= $this->session->flashdata('message'); ?>
            <form action="<?= base_url('login'); ?>" method="POST">
                <div class="form-group position-relative has-icon-left mb-4">
                    <input name="username" id="username" type="text" class="form-control form-control-xl" placeholder="Username">
    ...
    <div class="col-lg-7 d-none d-lg-block">
        <div id="auth-right">
            <img src="<?= base_url('assets/img') ?>/bgLogin.jpg" width="900" height="900">
        </div>
    </div>
</div>
